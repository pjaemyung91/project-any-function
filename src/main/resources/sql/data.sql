...
INSERT INTO customer (`name`, email, phone, pwd, `role`, created_at)
VALUES ('admin', 'admin@email.com', '01012345678', '$2a$12$.nwOhO69Nlj1sVf18GcavOcR/xOzqMiXKWsktOuLagsgPO31pRQLW', 'admin', CURDATE());


-- INSERT INTO accounts (customer_id, account_number, account_type, branch_address, created_at)
-- VALUES (1, 1865764534, 'Savings', '123 Teheran-ro, Seoul', CURDATE());
--
--
